...
#%%
gridcv_lgbm_params = {'bagging_fraction': 0.75, 'bagging_freq': 3,
                'bagging_seed': 7, 'eval_metric': 'l1', 'feature_fraction': 0.7,
                'learning_rate': 0.03, 'max_bin': 200, 'max_depth': 5,
                'n_estimators': 1000, 'num_boost_round': 50, 'num_leaves': 9,
                'objective': 'regression', 'reg_alpha': 0.0, 'verbose': -1}
